...
var translationLanguage = locale ? import_obsidian.moment.locale() : "en";
function error(str) {
...
var GithubPublisherSettings = class extends import_obsidian2.PluginSettingTab {
  ...
  renderUploadConfiguration() {
    ...
    const autoCleanExcludedSettings = new import_obsidian2.Setting(this.settingsPage).setName(settings("githubWorkflow", "excludedFiles")).setDesc(settings("githubWorkflow", "excludedFilesDesc")).setClass("obs-git-publisher-textarea").addTextArea((textArea) => {
      textArea.setPlaceholder("docs/assets/js, docs/assets/logo, /\\.js$/").setValue(this.plugin.settings.autoCleanUpExcluded.join(", ")).onChange((value) => __async(this, null, function* () {
...
// plugin/src/utils.ts
function convertOldSettings(settingsToConvert, plugin) {
  return __async(this, null, function* () {
    const settings2 = plugin.settings;
    const oldSettings = settings2[settingsToConvert];
    if (typeof oldSettings === "string") {
      settings2[settingsToConvert] = oldSettings === "" ? [] : oldSettings.split(/[,\n]\W*/);
      yield plugin.saveSettings();
    }
    settings2[settingsToConvert] = settings2[settingsToConvert].filter((e) => e !== "");
    yield plugin.saveSettings();
  });
}
...
function disablePublish(app2, settings2, file) {
  ...
  const folderList = settings2.excludedFolder;
  if (meta === void 0) {
    return false;
    ...
    return __async(this, null, function* () {
      try {
        ...
        try {
          ...
          noticeLog(`${e2} : ERROR with ${repoFrontmatter}`, this.settings);
          return false;
        }
      }
    });
...
var GithubPublisher = class extends import_obsidian11.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      yield convertOldSettings("ExcludedFolder", this);
      yield convertOldSettings("autoCleanUpExcluded", this);
